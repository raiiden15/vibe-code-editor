        ...
        <header className="flex h-16 shrink-0 items-center gap-2 border-b px-4">
          ...
          <div className="flex items-center gap-1">
            <Tooltip>
              ...
              <TooltipContent>Save (cntl + s)</TooltipContent>
            </Tooltip>
            ...
            openFiles.length > 0 ? (
              <div className="h-full flex flex-col">
                <div className="border-b bg-muted/30">
                  <Tabs value={activeFileId || ""} onValueChange={setActiveFileId}>
                    <div className="flex items-center justify-between px-4 py-2">
                        ...
                        {openFiles.map((file) => (
                          <TabsTrigger key={file.id} value={file.id} className="relative h-8 px-3 data-[state=active]:bg-background data-[state=active]:shadow-sm group">
                            <div className="flex items-center gap-2">
                              ...
                              <span className="ml-2 h-4 w-4 hover:bg-destructive hover:text-destructive-foreground rounded-sm flex items-center justify-center opacity-0 group-hover:opacity-100 transistion-opactiy cursor-pointer"
                                onClick={(e) => {
                                  e.stopPropagation();
                                  closeFile(file.id);
                                }}
                      ...
                      {openFiles.length > 1 && (
                        <Button size="sm" variant="ghost" onClick={closeAllFiles} className="h-6 px-2 text-xs">Close All</Button>
                      )}
                ...
                <div className="flex-1">
                  <ResizablePanelGroup direction="horizontal" className="f-full">
